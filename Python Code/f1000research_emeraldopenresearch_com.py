...
#Getting Page URLs
urls = ['https://emeraldopenresearch.com/search?q=covid-19&show=30&page=1',
        'https://f1000research.com/search?q=sars-cov-2&page=1',
        'https://f1000research.com/search?q=covid-19&page=1']
...
df_show_info.drop_duplicates(keep = 'first', inplace = True)
